// Code from https://raw.githubusercontent.com/lighttransport/nanort/master/examples/pbr_surface/gltf-loader.h

#ifndef BELOSGL_ARRAY_H
#define BELOSGL_ARRAY_H
